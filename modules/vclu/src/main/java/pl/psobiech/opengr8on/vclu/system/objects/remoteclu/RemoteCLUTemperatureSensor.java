...
public class RemoteCLUTemperatureSensor implements RemoteCLUSensor {
    ...
    public RemoteCLUTemperatureSensor(String discoveryPrefix, SpecificObject clu, SpecificObject object) {
        this.clu = clu;
        this.object = object;
